...
```ts
import { useCreateNewUser, useGetCourses, useEnrollUserInCourse, useGetMyEnrollments } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetMyEnrollments();
...
```js
import { createNewUser, getCourses, enrollUserInCourse, getMyEnrollments } from '@dataconnect/generated';
