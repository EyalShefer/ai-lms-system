...
export interface PromptField {
  id: string;
  label: string;           // "מקצוע"
  placeholder: string;     // "מתמטיקה, עברית..."
...
export const COMMON_FIELD_OPTIONS = {
  subjects: ['מתמטיקה', 'עברית', 'אנגלית', 'מדעים', 'היסטוריה', 'גאוגרפיה', 'אזרחות', 'תנ"ך', 'ספרות', 'אחר'],
  gradeLevels: ['א׳', 'ב׳', 'ג׳', 'ד׳', 'ה׳', 'ו׳', 'ז׳', 'ח׳', 'ט׳', 'י׳', 'י״א', 'י״ב'],
  difficultyLevels: ['קל', 'בינוני', 'מאתגר'],
